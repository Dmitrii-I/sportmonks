...
* Fix bug in `SoccerapiV2.fixtures` and `SoccerApiV2.fixtures_today`. When the parameters `league_ids` was specified and the resulting response contained more than 100 fixtures, then the fixtures beyond the first 100 contained also fixtures not belonging to the specified `league_ids`. 
