...
class TestSoccerApiV2(unittest.TestCase):
    ...
    def test_continent(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="continents/1", includes=["foo", "bar"]
        )
    ...
    def test_countries(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="countries", includes=["foo", "bar"]
        )
    ...
    def test_country(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="countries/1", includes=["foo", "bar"]
        )
    ...
    def test_leagues(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="leagues", includes=["foo", "bar"]
        )
    ...
    def test_league(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="leagues/1", includes=["foo", "bar"]
        )
    ...
    def test_seasons(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="seasons", includes=["foo", "bar"]
        )
    ...
    def test_season(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="seasons/1", includes=["foo", "bar"]
        )
    ...
    def test_season_results(self):
        ...
        # noinspection PyCallByClass, PyTypeChecker
        self.assertEqual(
            "foo", SoccerApiV2.season_results(api, season_id=1, includes=["foo", "bar"])
        )
        api.season.assert_called_once_with(
            season_id=1, includes=["results", "results.foo", "results.bar"]
        )
    ...
    def test_fixtures(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="fixtures/between/2000-01-01/2001-01-01",
            params={"leagues": [1]},
            includes=["foo", "bar"],
        )
    ...
    def test_fixture(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="fixtures/1", includes=["foo", "bar"]
        )
    ...
    def test_team_fixtures(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="fixtures/between/2000-01-01/2001-01-01/1", includes=["foo", "bar"]
        )
    ...
    def test_fixtures_today(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="livescores", params={"leagues": [1]}, includes=["foo", "bar"]
        )
    ...
    def test_fixtures_in_play(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="livescores/now", includes=["foo", "bar"]
        )
    ...
    def test_head_to_head_fixtures(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="head2head/1/2", includes=["foo", "bar"]
        )
    ...
    def test_video_highlights(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="highlights", includes=["foo", "bar"]
        )
        ...
        api._http_get.assert_called_once_with(
            endpoint="highlights/fixture/1", includes=["foo", "bar"]
        )
    ...
    def test_standings(self):
        ...
        api = MagicMock()
        # noinspection PyCallByClass, PyTypeChecker
        SoccerApiV2.standings(
            api, season_id=1, live=False, group_id=123, includes=["foo", "bar"]
        )
        api._http_get.assert_called_once_with(
            endpoint="standings/season/1",
            includes=["foo", "bar"],
            params={"group_id": 123},
        )
        ...
        api._http_get.assert_called_once_with(
            endpoint="standings/season/live/1",
    ...
    def test_teams(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="teams/season/1", includes=["foo", "bar"]
        )
    ...
    def test_team(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="teams/1", includes=["foo", "bar"]
        )
    ...
    def test_top_scorers(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="topscorers/season/1", includes=["foo", "bar"]
        )
    ...
    def test_rounds(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="rounds/season/1", includes=["foo", "bar"]
        )
    ...
    def test_round(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="rounds/1", includes=["foo", "bar"]
        )
    ...
    def test_squad(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="squad/season/1/team/2", includes=["foo", "bar"]
        )
    ...
    def test_meta(self, mocked_requests_get):
        ...
        mocked_requests_get.assert_called_once_with(
            url="http://foo.bar/continents", params="params", headers="headers"
        )
    ...
    def test_stage(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="stages/1", includes=["foo", "bar"]
        )
    ...
    def test_season_stages(self):
        ...
        api._http_get.assert_called_once_with(
            endpoint="stages/season/1", includes=["foo", "bar"]
        )
